function Spostactivation(scriptName)
    fprintf('Running %s\n', scriptName);
    ...
    SpaFiles = fileList(contains({fileList.name}, 'SpostActivation'));
    ...
    for fileIdx = 1:length(SpaFiles)
        fileName = SpaFiles(fileIdx).name;
    ...
    disp('Source postactivation plot complete.');
